...
// Items array
const items = [
    {name: "I am Bear Clan", clan: "Agedzöni'ga:'", image: "../images/bear.png", audio: "../audio/Bear - SenecaClan.mp3"},
    {name: "I am Deer Clan", clan: "Agé:nyögwaiyo'", image: "../images/deer.png", audio: "../audio/Deer - SenecaClan.mp3"},
    {name: "I am Wolf CLan", clan: "Agáta:yö:nih", image: "../images/wolf.png", audio: "../audio/Wolf - SenecaClan.mp3"},
    {name: "I am Turtle Clan", clan: "Genyáhdë:h", image: "../images/turtle.png", audio: "../audio/Turtle - SenecaClan.mp3"},
    {name: "I am Beaver Clan", clan: "Agégë'ge:ga:'", image: "../images/beaver.png", audio: "../audio/Beaver - SenecaClan.mp3"},
    {name: "I am Heron Clan", clan: "Agadáë'ö:ga:'", image: "../images/heron.png", audio: "../audio/Heron - SenecaClan.mp3"},
    {name: "I am Snipe Clan", clan: "Agé'nehsi:yo'", image: "../images/sandpiper.png", audio: "../audio/Snipe - SenecaClan.mp3"},
    {name: "I am Hawk Clan", clan: "Agéswë'gaiyo'", image: "../images/hawk.png", audio: "../audio/Hawk - SenecaClan.mp3"},
];
