...
// Items array
const items = [
    {name: "Shirt / Coat / Dress", clan: "Ada'dawí'tshä'", image: "../images/dress.png", audio: "../audio/"},
    {name: "Pants", clan: "Gahná'tsha'", image: "../images/pants.png", audio: "../audio/"},
    {name: "Shoe / Boot / Sneaker", clan: "Ahdáhgwa'", image: "../images/shoes.png", audio: "../audio/"},
    {name: "Moccasin", clan: "Ahdahgwa'óñ∙weh", image: "../images/moccasin.png", audio: "../audio/"},
    {name: "Hat", clan: "Eñnoñhé'tshä∙'", image: "../images/hat.png", audio: "../audio/"},
    {name: "Gloves / Mittens", clan: "Eñ'nyótshä∙'", image: "../images/gloves.png", audio: "../audio/"},
    {name: "Socks", clan: "Adá∙hditsä'", image: "../images/socks.png", audio: "../audio/"},
    {name: "Cane", clan: "Ada'ditshä∙'", image: "../images/cane.png", audio: "../audio/"},
    {name: "Bag", clan: "Gayá∙ä'", image: "../images/bag.png", audio: "../audio/"},
];
