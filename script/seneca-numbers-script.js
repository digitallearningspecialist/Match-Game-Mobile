...
// Items array
const items = [
    {name: "One", clan: "Sga:d", image: "../images/number-1-black.png", audio: "../audio/"},
    {name: "Two", clan: "Dekni:h", image: "../images/number-2-turquoise.png", audio: "../audio/"},
    {name: "Three", clan: "Sëh", image: "../images/number-3-blue.png", audio: "../audio/"},
    {name: "Four", clan: "Ge:ih", image: "../images/number-4-yellow.png", audio: "../audio/"},
    {name: "Five", clan: "Wis", image: "../images/number-5-green.png", audio: "../audio/"},
    {name: "Six", clan: "Ye:i'", image: "../images/number-6-purple.png", audio: "../audio/"},
    {name: "Seven", clan: "Dza:dak", image: "../images/number-7-orange.png", audio: "../audio/"},
    {name: "Eight", clan: "Degyö'", image: "../images/number-8-red.png", audio: "../audio/"},
    {name: "Nine", clan: "Johdö:h", image: "../images/number-9-brown.png", audio: "../audio/"},
    {name: "Ten", clan: "Washë:h", image: "../images/number-10-white.png", audio: "../audio/"},
];
