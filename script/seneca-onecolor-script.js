...
// Items array
const items = [
    {name: "Waabshkaa", word: "it is white", image: "../images/whitetshirt.png", audio: "../audio/nyagai.mp3"},
    {name: "Zaawaa", word: "it is yellow", image: "../images/yellowcoat.png", audio: "../audio/neoge.mp3"},
    {name: "Miskwaa", word: "it is red", image: "../images/redball.png", audio: "../audio/otayonih.mp3"},
    {name: "Mkadewaa", word: "it is black", image: "../images/blackbag.png", audio: "../audio/hanowah.mp3"},
    {name: "Zhaawshkwaa", word: "it is green", image: "../images/greenhat.png", audio: "../audio/noganyagoh.mp3"},
    {name: "Waabshkizi", word: "it is white", image: "../images/whiteclock.png", audio: "../audio/nyagai.mp3"},
    {name: "Zaawzi", word: "it is yellow", image: "../images/yellowbird.png", audio: "../audio/neoge.mp3"},
    {name: "Miskwzi", word: "it is red", image: "../images/redapple.png", audio: "../audio/otayonih.mp3"},
    {name: "Mkadewzi", word: "it is black", image: "../images/blackcat.png", audio: "../audio/hanowah.mp3"},
    {name: "Zhaawshkwzi", word: "it is green", image: "../images/greenapple.png", audio: "../audio/noganyagoh.mp3"},
];
        ...
        <div class="card-container container-fluid" data-card-value="${cardValues[i].name}" data-audio-value="${cardValues[i].audio}">
            ...
            <div class="card card-after text-center container-fluid">
                <div class"card container-fluid">
                    <p class="card-title cardtext">${cardValues[i].word}</p>
