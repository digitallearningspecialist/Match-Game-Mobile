...
// Items array
const items = [
    {name: "Food", clan: "Gakwa'", image: "../images/food.png", audio: "../audio/"},
    {name: "Butter", clan: "Owisä:ta'", image: "../images/butter.png", audio: "../audio/"},
    {name: "Salt", clan: "Ojíke'da'", image: "../images/salt.png", audio: "../audio/"},
    {name: "Pepper", clan: "Deyóhsait", image: "../images/pepper.png", audio: "../audio/"},
    {name: "Meat", clan: "O'wà:'", image: "../images/meat.png", audio: "../audio/"},
    {name: "Corn", clan: "Onëö'", image: "../images/corn.png", audio: "../audio/"},
    {name: "Beans", clan: "Osáe'da'", image: "../images/beans.png", audio: "../audio/"},
    {name: "Squash", clan: "O:nyö́hsa'", image: "../images/squash.png", audio: "../audio/"},
    {name: "Corn Bread", clan: "Gagáehdë́hdöh.", image: "../images/cornbread.png", audio: "../audio/"},
    {name: "Pizza", clan: "Gáíhdo'yá'ka:' degà:hgwá'se:'", image: "../images/pizza.png", audio: "../audio/"},
    {name: "Eggs", clan: "O'hö́hsa", image: "../images/eggs.png", audio: "../audio/"},
];
