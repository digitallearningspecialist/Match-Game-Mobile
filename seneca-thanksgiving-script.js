...
// Items array
const items = [
    {name: "All of the People", clan: "Ha’deyögwe’dage:h", image: "overpopulation.gif", audio: ""},
    {name: "Our Mother Earth", clan: "Etinö’ëh Yöëdzade’", image: "earth.gif", audio: ""},
    {name: "Water", clan: "Oneganos", image: "rain-water.gif", audio: ""},
    {name: "All the Grasses", clan: "Ha’deyogeo’dza:ge:h", image: "grass.gif", audio: ""},
    {name: "All the Medicines", clan: "Ha’deyonöhgwa’shä:ge:h", image: "sprout.gif", audio: ""},
    {name: "All the Berries", clan: "Ha’deyojiyage:h", image: "berries.gif", audio: ""},
    {name: "Strawberry", clan: "Ojisdöda’shä’", image: "strawberry.gif", audio: ""},
    {name: "Forest", clan: "Gahadayë’", image: "environment.gif", audio: ""},
    {name: "Maple", clan: "Wahda’", image: "maple-leaf.gif", audio: ""},
    {name: "All the Animals", clan: "Ha’deganyo’dage:h", image: "footprint.gif", audio: ""},
    {name: "All of the Birds", clan: "Ha’degaji’dage:h", image: "bird.gif", audio: ""},
    {name: "Our Life Sustainers (3 Sisters)", clan: "Jöhehgöh", image: "vegetables.gif", audio: ""},
    {name: "Wind", clan: "Deyäwë:nye:h", image: "wind.gif", audio: ""},
    {name: "Our Grandparents Thunderers", clan: "Etihso:d Hadiwënodaje’s", image: "grandparents.gif", audio: ""},
    {name: "Our elder brother Daytime Orb", clan: "Sedwahji’ Ëde:ka:’ Gähgwa:’", image: "sun.gif", audio: ""},
    {name: "Our Grandmother Night time Orb", clan: "Etihso:d Söëka:’ Gähgwa:’", image: "moon.gif", audio: ""},
    {name: "Stars", clan: "Gajihsö’dëönyö’", image: "shooting-star.gif", audio: ""},
    {name: "Handsome Lake", clan: "Ganyodaiyo’", image: "teamwork.gif", audio: ""},
    {name: "Sky Dwellers", clan: "Hadiöya’ge:onö’", image: "data.gif", audio: ""},
    {name: "Our Creator", clan: "Sögwajëno’kda’öh", image: "eco-earth.gif", audio: ""},
];
